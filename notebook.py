# -*- coding: utf-8 -*-
"""
Notebook padrao de analise grafica do projeto Preferencial - NCA-SEM.

As visualizações deste arquivo são descritivas. A leitura de NCA/SEM ocorre
somente quando resultados metodologicamente especificados são escritos na
planilha; linhas de teto e relações estruturais não demonstram causalidade
direta por si sós.
...
PROJECT_NAME = "Preferencial - NCA-SEM"
