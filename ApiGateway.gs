...
function gw_login_(username, password) {
  try {
    ...
    if (typeof Auth_login === 'function')              entries.push(function (form) { return Auth_login.apply(null, form); });
    if (typeof Auth_loginWithPassword === 'function')              entries.push(function (form) { return Auth_loginWithPassword.apply(null, form); });
