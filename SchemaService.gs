...
const PROJECT_SCHEMA_DEFINITIONS = {"ALUNOS":{"entity":"ALUNOS","sheetName":"Alunos","headers":["ID","Name","Email","Phone","Class","GuardianName","GuardianPhone","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"CRUD_Alunos.gs"},"AUDIT_LOGS":{"entity":"AUDIT_LOGS","sheetName":"Audit_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"ESCOLAS":{"entity":"ESCOLAS","sheetName":"Escolas","headers":["ID","Name","Code","Address","City","State","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"CRUD_Escolas.gs"},"NAME":{"entity":"NAME","sheetName":"DB_Educacional","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"Config.gs"},"PROFESSORES":{"entity":"PROFESSORES","sheetName":"Professores","headers":["ID","Name","Email","Phone","Subject","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"CRUD_Professores.gs"},"SETTINGS":{"entity":"SETTINGS","sheetName":"Settings","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"baseline"},"USER":{"entity":"USER","sheetName":"User","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"CRUD_User.gs"},"USERS":{"entity":"USERS","sheetName":"Users","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"}};

// Aba real lida pelo login por senha deste projeto (ver Auth/UserAuth).
